; RUN: opt -S -load LLVMPolyJIT.so -polly-detect-unprofitable -polly-delinearize=false -polli-detect -jitable -polly-detect-keep-going -analyze < %s 2>&1 | FileCheck %s
