...
; ModuleID = '/local/hdd/pjtest/pj-collect/MultiSourceBenchmarks/test-suite/MultiSource/Benchmarks/mafft/Ralignmm.c.R__align_if.else.799.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @R__align_if.else.799.pjit.scop(i1 %cmp.i.1326, float*, i32 %conv.i.1319, i64 %call2.i.1320, i64 %call.i.1318, i32**, i32 %conv3.i.1321, float* %currentw.0.lcssa)  {
newFuncRoot:
  br label %if.else.799

for.cond.47.preheader.i.exitStub:                 ; preds = %for.cond.47.preheader.i.loopexit, %for.cond.24.preheader.i, %if.else.799
  ret void

if.else.799:                                      ; preds = %newFuncRoot
  br i1 %cmp.i.1326, label %for.cond.47.preheader.i.exitStub, label %if.else.i

if.else.i:                                        ; preds = %if.else.799
  %2 = load float, float* %0, align 4, !tbaa !0
  %cmp11.45.i = icmp sgt i32 %conv.i.1319, 0
  br i1 %cmp11.45.i, label %for.body.lr.ph.i.1279, label %for.cond.24.preheader.i

for.body.lr.ph.i.1279:                            ; preds = %if.else.i
  %sext5.i = shl i64 %call2.i.1320, 32
  %idxprom20.i = ashr exact i64 %sext5.i, 32
  %sext6.i = shl i64 %call.i.1318, 32
  %idxprom21.i = ashr exact i64 %sext6.i, 32
  %arrayidx22.i = getelementptr inbounds i32*, i32** %1, i64 %idxprom21.i
  %3 = trunc i64 %call.i.1318 to i32
  br label %for.body.i.1280

for.body.i.1280:                                  ; preds = %for.inc.i, %for.body.lr.ph.i.1279
  %indvars.iv73.i = phi i64 [ 0, %for.body.lr.ph.i.1279 ], [ %indvars.iv.next74.i, %for.inc.i ]
  %wm.046.i = phi float [ %2, %for.body.lr.ph.i.1279 ], [ %wm.1.i, %for.inc.i ]
...
for.inc.i:                                        ; preds = %if.then.16.i, %for.body.i.1280
  %wm.1.i = phi float [ %4, %if.then.16.i ], [ %wm.046.i, %for.body.i.1280 ]
  %indvars.iv.next74.i = add nuw nsw i64 %indvars.iv73.i, 1
  %lftr.wideiv1605 = trunc i64 %indvars.iv.next74.i to i32
  %exitcond1606 = icmp eq i32 %lftr.wideiv1605, %3
  br i1 %exitcond1606, label %for.cond.24.preheader.i.loopexit, label %for.body.i.1280
...
for.cond.24.preheader.i:                          ; preds = %for.cond.24.preheader.i.loopexit, %if.else.i
  ...
  %cmp25.42.i = icmp sgt i32 %conv3.i.1321, 0
...
for.inc.43.i:                                     ; preds = %if.then.32.i, %for.body.27.i
  ...
  %lftr.wideiv1603 = trunc i64 %indvars.iv.next70.i to i32
  %exitcond1604 = icmp eq i32 %lftr.wideiv1603, %5
  br i1 %exitcond1604, label %for.cond.47.preheader.i.loopexit, label %for.body.27.i
...
if.then.32.i:                                     ; preds = %for.body.27.i
  ...
  %sub362.i = sub i32 %7, %conv3.i.1321
...
if.then.16.i:                                     ; preds = %for.body.i.1280
  %9 = sub i64 %call.i.1318, %indvars.iv73.i
