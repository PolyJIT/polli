...
; ModuleID = '/local/hdd/pjtest/pj-collect/MultiSourceBenchmarks/test-suite/MultiSource/Benchmarks/mafft/partQalignmm.c.partQ__align_if.else.625.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @partQ__align_if.else.625.pjit.scop(i1 %cmp.i.1137, float*, i32 %conv.i.1134, i64 %call2.i.1135, i64 %call.i.1133, i32**, i32 %conv3.i.1136, float* %currentw.0.lcssa)  {
newFuncRoot:
  br label %if.else.625

for.cond.42.preheader.i.exitStub:                 ; preds = %for.cond.42.preheader.i.loopexit, %for.cond.19.preheader.i, %if.else.625
  ret void

if.else.625:                                      ; preds = %newFuncRoot
  br i1 %cmp.i.1137, label %for.cond.42.preheader.i.exitStub, label %if.else.i

if.else.i:                                        ; preds = %if.else.625
  %2 = load float, float* %0, align 4, !tbaa !0
  %cmp6.43.i = icmp sgt i32 %conv.i.1134, 0
  br i1 %cmp6.43.i, label %for.body.lr.ph.i.1108, label %for.cond.19.preheader.i

for.body.lr.ph.i.1108:                            ; preds = %if.else.i
  %sext5.i = shl i64 %call2.i.1135, 32
  %idxprom15.i = ashr exact i64 %sext5.i, 32
  %sext6.i = shl i64 %call.i.1133, 32
  %idxprom16.i = ashr exact i64 %sext6.i, 32
  %arrayidx17.i = getelementptr inbounds i32*, i32** %1, i64 %idxprom16.i
  %3 = trunc i64 %call.i.1133 to i32
  br label %for.body.i.1109

for.body.i.1109:                                  ; preds = %for.inc.i, %for.body.lr.ph.i.1108
  %indvars.iv177.i = phi i64 [ 0, %for.body.lr.ph.i.1108 ], [ %indvars.iv.next178.i, %for.inc.i ]
  %wm.045.i = phi float [ %2, %for.body.lr.ph.i.1108 ], [ %wm.1.i, %for.inc.i ]
...
for.inc.i:                                        ; preds = %if.then.11.i, %for.body.i.1109
  %wm.1.i = phi float [ %4, %if.then.11.i ], [ %wm.045.i, %for.body.i.1109 ]
  %indvars.iv.next178.i = add nuw nsw i64 %indvars.iv177.i, 1
  %lftr.wideiv1576 = trunc i64 %indvars.iv.next178.i to i32
  %exitcond1577 = icmp eq i32 %lftr.wideiv1576, %3
  br i1 %exitcond1577, label %for.cond.19.preheader.i.loopexit, label %for.body.i.1109
...
for.cond.19.preheader.i:                          ; preds = %for.cond.19.preheader.i.loopexit, %if.else.i
  ...
  %cmp20.40.i = icmp sgt i32 %conv3.i.1136, 0
...
for.inc.38.i:                                     ; preds = %if.then.27.i, %for.body.22.i
  ...
  %lftr.wideiv1574 = trunc i64 %indvars.iv.next174.i to i32
  %exitcond1575 = icmp eq i32 %lftr.wideiv1574, %5
  br i1 %exitcond1575, label %for.cond.42.preheader.i.loopexit, label %for.body.22.i
...
if.then.27.i:                                     ; preds = %for.body.22.i
  ...
  %sub312.i = sub i32 %7, %conv3.i.1136
...
if.then.11.i:                                     ; preds = %for.body.i.1109
  %9 = sub i64 %call.i.1133, %indvars.iv177.i
