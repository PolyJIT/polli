...
; ModuleID = '/local/hdd/pjtest/pj-collect/MultiSourceBenchmarks/test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/sgrep.c.prep_for.body.38.lr.ph.us202.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @prep_for.body.38.lr.ph.us202.pjit.scop(i32 %sub29.us, i8* %Pattern, i32 %div, i32 %sub2, i32, i32* nonnull %shift_1)  {
newFuncRoot:
  br label %for.body.38.lr.ph.us202

for.cond.30.for.inc.63_crit_edge.us.loopexit.exitStub: ; preds = %for.cond.34.for.inc.60_crit_edge.us207
  ret void

for.body.38.lr.ph.us202:                          ; preds = %for.cond.34.for.inc.60_crit_edge.us207, %newFuncRoot
  %indvars.iv220 = phi i64 [ %indvars.iv.next221, %for.cond.34.for.inc.60_crit_edge.us207 ], [ 1, %newFuncRoot ]
...
for.cond.34.for.inc.60_crit_edge.us207:           ; preds = %for.inc.57.us193
  ...
  br i1 %exitcond237, label %for.cond.30.for.inc.63_crit_edge.us.loopexit.exitStub, label %for.body.38.lr.ph.us202
}
