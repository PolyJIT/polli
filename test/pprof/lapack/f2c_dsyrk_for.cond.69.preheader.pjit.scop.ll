...
; ModuleID = 'dsyrk.c.f2c_dsyrk_for.cond.69.preheader.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @f2c_dsyrk_for.cond.69.preheader.pjit.scop(i1 %cmp60.645, i64, i64, double* %beta, double* %add.ptr3)  {
newFuncRoot:
...
for.body.74:                                      ; preds = %for.body.74, %for.body.74.lr.ph
  ...
  %arrayidx77 = getelementptr inbounds double, double* %add.ptr3, i64 %add76
  %4 = load double, double* %arrayidx77, align 8, !tbaa !0
  %mul78 = fmul double %3, %4
  store double %mul78, double* %arrayidx77, align 8, !tbaa !0
