...
; ModuleID = 'dtbmv.c.f2c_dtbmv_for.body.244.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @f2c_dtbmv_for.body.244.pjit.scop(i64, double* %incdec.ptr, i64, i64 %add239, double* %add.ptr, i64)  {
newFuncRoot:
...
for.body.244:                                     ; preds = %for.end.273, %newFuncRoot
  ...
  %arrayidx245 = getelementptr inbounds double, double* %incdec.ptr, i64 %j.4767
  %3 = load double, double* %arrayidx245, align 8, !tbaa !0
  %mul249 = mul nsw i64 %j.4767, %1
  %add250 = add nsw i64 %mul249, %add239
  %arrayidx251 = getelementptr inbounds double, double* %add.ptr, i64 %add250
  %4 = load double, double* %arrayidx251, align 8, !tbaa !0
  %mul252 = fmul double %3, %4
...
for.body.263:                                     ; preds = %for.body.263, %for.body.263.lr.ph
  ...
  %temp.1764 = phi double [ %mul252, %for.body.263.lr.ph ], [ %add270, %for.body.263 ]
  %i__.4765 = add nsw i64 %i__.4765.in, -1
  %add266 = add i64 %add264, %i__.4765
  %arrayidx267 = getelementptr inbounds double, double* %add.ptr, i64 %add266
  %5 = load double, double* %arrayidx267, align 8, !tbaa !0
  %arrayidx268 = getelementptr inbounds double, double* %incdec.ptr, i64 %i__.4765
  %6 = load double, double* %arrayidx268, align 8, !tbaa !0
  %mul269 = fmul double %5, %6
  %add270 = fadd double %temp.1764, %mul269
...
for.end.273.loopexit:                             ; preds = %for.body.263
  %add270.lcssa = phi double [ %add270, %for.body.263 ]
  br label %for.end.273

for.end.273:                                      ; preds = %for.end.273.loopexit, %for.body.244
  %temp.1.lcssa = phi double [ %mul252, %for.body.244 ], [ %add270.lcssa, %for.end.273.loopexit ]
  store double %temp.1.lcssa, double* %arrayidx245, align 8, !tbaa !0
