...
; ModuleID = 'dtrmm.c.f2c_dtrmm_for.body.186.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @f2c_dtrmm_for.body.186.pjit.scop(i1 %cmp188.960, i64, i1 %tobool193, i64, double* %add.ptr3, i64, double* %add.ptr, double* %alpha, i64)  {
newFuncRoot:
...
for.body.189.us:                                  ; preds = %for.end.214.us, %for.body.189.us.preheader
  ...
  %arrayidx192.us = getelementptr inbounds double, double* %add.ptr3, i64 %add191.us
  %4 = load double, double* %arrayidx192.us, align 8, !tbaa !0
...
for.body.203.us:                                  ; preds = %for.body.203.us, %for.body.203.lr.ph.us
  %temp.2959.us = phi double [ %4, %for.body.203.lr.ph.us ], [ %add211.us, %for.body.203.us ]
  %k.2958.us = phi i64 [ 1, %for.body.203.lr.ph.us ], [ %inc213.us, %for.body.203.us ]
  %add205.us = add nsw i64 %k.2958.us, %mul204.us
  %arrayidx206.us = getelementptr inbounds double, double* %add.ptr, i64 %add205.us
  %5 = load double, double* %arrayidx206.us, align 8, !tbaa !0
  %add208.us = add nsw i64 %k.2958.us, %mul190
  %arrayidx209.us = getelementptr inbounds double, double* %add.ptr3, i64 %add208.us
  %6 = load double, double* %arrayidx209.us, align 8, !tbaa !0
  %mul210.us = fmul double %5, %6
  %add211.us = fadd double %temp.2959.us, %mul210.us
...
for.end.214.us.loopexit:                          ; preds = %for.body.203.us
  %add211.us.lcssa = phi double [ %add211.us, %for.body.203.us ]
  br label %for.end.214.us

for.end.214.us:                                   ; preds = %for.end.214.us.loopexit, %for.body.189.us
  %temp.2.lcssa.us = phi double [ %4, %for.body.189.us ], [ %add211.us.lcssa, %for.end.214.us.loopexit ]
  %7 = load double, double* %alpha, align 8, !tbaa !0
  %mul215.us = fmul double %temp.2.lcssa.us, %7
  store double %mul215.us, double* %arrayidx192.us, align 8, !tbaa !0
...
for.body.189:                                     ; preds = %for.end.214, %for.body.189.preheader
  ...
  %arrayidx192 = getelementptr inbounds double, double* %add.ptr3, i64 %add191
  %8 = load double, double* %arrayidx192, align 8, !tbaa !0
  %mul195 = mul nsw i64 %indvars.iv1048, %2
  %add196 = add nsw i64 %mul195, %indvars.iv1048
  %arrayidx197 = getelementptr inbounds double, double* %add.ptr, i64 %add196
  %9 = load double, double* %arrayidx197, align 8, !tbaa !0
  %mul198 = fmul double %8, %9
...
for.body.203:                                     ; preds = %for.body.203, %for.body.203.lr.ph
  %temp.2959 = phi double [ %mul198, %for.body.203.lr.ph ], [ %add211, %for.body.203 ]
  %k.2958 = phi i64 [ 1, %for.body.203.lr.ph ], [ %inc213, %for.body.203 ]
  %add205 = add nsw i64 %k.2958, %mul204
  %arrayidx206 = getelementptr inbounds double, double* %add.ptr, i64 %add205
  %10 = load double, double* %arrayidx206, align 8, !tbaa !0
  %add208 = add nsw i64 %k.2958, %mul190
  %arrayidx209 = getelementptr inbounds double, double* %add.ptr3, i64 %add208
  %11 = load double, double* %arrayidx209, align 8, !tbaa !0
  %mul210 = fmul double %10, %11
  %add211 = fadd double %temp.2959, %mul210
...
for.end.214.loopexit:                             ; preds = %for.body.203
  %add211.lcssa = phi double [ %add211, %for.body.203 ]
  br label %for.end.214

for.end.214:                                      ; preds = %for.end.214.loopexit, %for.body.189
  %temp.2.lcssa = phi double [ %mul198, %for.body.189 ], [ %add211.lcssa, %for.end.214.loopexit ]
  %12 = load double, double* %alpha, align 8, !tbaa !0
  %mul215 = fmul double %temp.2.lcssa, %12
  store double %mul215, double* %arrayidx192, align 8, !tbaa !0
