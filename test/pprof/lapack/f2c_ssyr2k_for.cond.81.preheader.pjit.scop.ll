...
; ModuleID = 'ssyr2k.c.f2c_ssyr2k_for.cond.81.preheader.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @f2c_ssyr2k_for.cond.81.preheader.pjit.scop(i1 %cmp72.788, i64, i64, float* %beta, float* %add.ptr6)  {
newFuncRoot:
...
for.body.86:                                      ; preds = %for.body.86, %for.body.86.lr.ph
  ...
  %arrayidx89 = getelementptr inbounds float, float* %add.ptr6, i64 %add88
  %4 = load float, float* %arrayidx89, align 4, !tbaa !0
  %mul90 = fmul float %3, %4
  store float %mul90, float* %arrayidx89, align 4, !tbaa !0
