...
; ModuleID = 'stbsv.c.f2c_stbsv_for.body.236.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @f2c_stbsv_for.body.236.pjit.scop(float* %incdec.ptr, i64, i64 %add231, i64, float* %add.ptr, i64)  {
newFuncRoot:
...
for.body.236:                                     ; preds = %if.then.260, %newFuncRoot
  ...
  %arrayidx237 = getelementptr inbounds float, float* %incdec.ptr, i64 %j.4765
  %3 = load float, float* %arrayidx237, align 4, !tbaa !0
...
for.body.248:                                     ; preds = %for.body.248, %for.body.248.lr.ph
  %temp.0763 = phi float [ %3, %for.body.248.lr.ph ], [ %sub255, %for.body.248 ]
  %i__.4762 = phi i64 [ %cond245, %for.body.248.lr.ph ], [ %inc257, %for.body.248 ]
  %add251 = add i64 %add249, %i__.4762
  %arrayidx252 = getelementptr inbounds float, float* %add.ptr, i64 %add251
  %4 = load float, float* %arrayidx252, align 4, !tbaa !0
  %arrayidx253 = getelementptr inbounds float, float* %incdec.ptr, i64 %i__.4762
  %5 = load float, float* %arrayidx253, align 4, !tbaa !0
  %mul254 = fmul float %4, %5
  %sub255 = fsub float %temp.0763, %mul254
...
if.then.260.loopexit:                             ; preds = %for.body.248
  %sub255.lcssa = phi float [ %sub255, %for.body.248 ]
  br label %if.then.260

if.then.260:                                      ; preds = %if.then.260.loopexit, %for.body.236
  %temp.0.lcssa = phi float [ %3, %for.body.236 ], [ %sub255.lcssa, %if.then.260.loopexit ]
  %mul261 = mul nsw i64 %j.4765, %1
  %add262 = add nsw i64 %mul261, %add231
  %arrayidx263 = getelementptr inbounds float, float* %add.ptr, i64 %add262
  %6 = load float, float* %arrayidx263, align 4, !tbaa !0
  %div264 = fdiv float %temp.0.lcssa, %6
  store float %div264, float* %arrayidx237, align 4, !tbaa !0
