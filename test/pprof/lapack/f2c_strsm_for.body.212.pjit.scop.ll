...
; ModuleID = 'strsm.c.f2c_strsm_for.body.212.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @f2c_strsm_for.body.212.pjit.scop(i1 %cmp214.1102, i64, i64, i1 %tobool235, float* %alpha, float* %add.ptr3, i64, float* %add.ptr, i64)  {
newFuncRoot:
...
for.body.215.us:                                  ; preds = %if.end.241.us, %for.body.215.us.preheader
  ...
  %4 = load float, float* %alpha, align 4, !tbaa !0
  %add217.us = add nsw i64 %indvars.iv1201, %mul216
  %arrayidx218.us = getelementptr inbounds float, float* %add.ptr3, i64 %add217.us
  %5 = load float, float* %arrayidx218.us, align 4, !tbaa !0
  %mul219.us = fmul float %4, %5
...
for.body.223.us:                                  ; preds = %for.body.223.us, %for.body.223.lr.ph.us
  %temp.01101.us = phi float [ %mul219.us, %for.body.223.lr.ph.us ], [ %sub231.us, %for.body.223.us ]
  %k.21100.us = phi i64 [ 1, %for.body.223.lr.ph.us ], [ %inc233.us, %for.body.223.us ]
  %add225.us = add nsw i64 %k.21100.us, %mul224.us
  %arrayidx226.us = getelementptr inbounds float, float* %add.ptr, i64 %add225.us
  %6 = load float, float* %arrayidx226.us, align 4, !tbaa !0
  %add228.us = add nsw i64 %k.21100.us, %mul216
  %arrayidx229.us = getelementptr inbounds float, float* %add.ptr3, i64 %add228.us
  %7 = load float, float* %arrayidx229.us, align 4, !tbaa !0
  %mul230.us = fmul float %6, %7
  %sub231.us = fsub float %temp.01101.us, %mul230.us
...
if.end.241.us.loopexit:                           ; preds = %for.body.223.us
  %sub231.us.lcssa = phi float [ %sub231.us, %for.body.223.us ]
  br label %if.end.241.us

if.end.241.us:                                    ; preds = %if.end.241.us.loopexit, %for.body.215.us
  %temp.0.lcssa.us = phi float [ %mul219.us, %for.body.215.us ], [ %sub231.us.lcssa, %if.end.241.us.loopexit ]
  store float %temp.0.lcssa.us, float* %arrayidx218.us, align 4, !tbaa !0
...
for.body.215:                                     ; preds = %if.then.236, %for.body.215.preheader
  ...
  %8 = load float, float* %alpha, align 4, !tbaa !0
  %add217 = add nsw i64 %indvars.iv1197, %mul216
  %arrayidx218 = getelementptr inbounds float, float* %add.ptr3, i64 %add217
  %9 = load float, float* %arrayidx218, align 4, !tbaa !0
  %mul219 = fmul float %8, %9
...
for.body.223:                                     ; preds = %for.body.223, %for.body.223.lr.ph
  %temp.01101 = phi float [ %mul219, %for.body.223.lr.ph ], [ %sub231, %for.body.223 ]
  %k.21100 = phi i64 [ 1, %for.body.223.lr.ph ], [ %inc233, %for.body.223 ]
  %add225 = add nsw i64 %k.21100, %mul224
  %arrayidx226 = getelementptr inbounds float, float* %add.ptr, i64 %add225
  %10 = load float, float* %arrayidx226, align 4, !tbaa !0
  %add228 = add nsw i64 %k.21100, %mul216
  %arrayidx229 = getelementptr inbounds float, float* %add.ptr3, i64 %add228
  %11 = load float, float* %arrayidx229, align 4, !tbaa !0
  %mul230 = fmul float %10, %11
  %sub231 = fsub float %temp.01101, %mul230
...
if.then.236.loopexit:                             ; preds = %for.body.223
  %sub231.lcssa = phi float [ %sub231, %for.body.223 ]
  br label %if.then.236

if.then.236:                                      ; preds = %if.then.236.loopexit, %for.body.215
  %temp.0.lcssa = phi float [ %mul219, %for.body.215 ], [ %sub231.lcssa, %if.then.236.loopexit ]
  %mul237 = mul nsw i64 %indvars.iv1197, %2
  %add238 = add nsw i64 %mul237, %indvars.iv1197
  %arrayidx239 = getelementptr inbounds float, float* %add.ptr, i64 %add238
  %12 = load float, float* %arrayidx239, align 4, !tbaa !0
  %div240 = fdiv float %temp.0.lcssa, %12
  store float %div240, float* %arrayidx218, align 4, !tbaa !0
