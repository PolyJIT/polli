...
; ModuleID = 'strsv.c.f2c_strsv_for.body.200.lr.ph.pjit.scop.prototype'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind
define weak void @f2c_strsv_for.body.200.lr.ph.pjit.scop(i64 %call40, float* %incdec.ptr, i64, float* %add.ptr, i64)  {
newFuncRoot:
...
for.body.200.us:                                  ; preds = %if.end.221.us, %for.body.200.us.preheader
  ...
  %arrayidx201.us = getelementptr inbounds float, float* %incdec.ptr, i64 %indvars.iv
  %2 = load float, float* %arrayidx201.us, align 4, !tbaa !0
...
for.body.205.us:                                  ; preds = %for.body.205.us, %for.body.205.lr.ph.us
  %temp.0600.us = phi float [ %2, %for.body.205.lr.ph.us ], [ %sub211.us, %for.body.205.us ]
  %i__.4599.us = phi i64 [ 1, %for.body.205.lr.ph.us ], [ %inc213.us, %for.body.205.us ]
  %add207.us = add nsw i64 %i__.4599.us, %mul206.us
  %arrayidx208.us = getelementptr inbounds float, float* %add.ptr, i64 %add207.us
  %3 = load float, float* %arrayidx208.us, align 4, !tbaa !0
  %arrayidx209.us = getelementptr inbounds float, float* %incdec.ptr, i64 %i__.4599.us
  %4 = load float, float* %arrayidx209.us, align 4, !tbaa !0
  %mul210.us = fmul float %3, %4
  %sub211.us = fsub float %temp.0600.us, %mul210.us
...
if.end.221.us.loopexit:                           ; preds = %for.body.205.us
  %sub211.us.lcssa = phi float [ %sub211.us, %for.body.205.us ]
  br label %if.end.221.us

if.end.221.us:                                    ; preds = %if.end.221.us.loopexit, %for.body.200.us
  %temp.0.lcssa.us = phi float [ %2, %for.body.200.us ], [ %sub211.us.lcssa, %if.end.221.us.loopexit ]
  store float %temp.0.lcssa.us, float* %arrayidx201.us, align 4, !tbaa !0
...
for.body.200:                                     ; preds = %if.then.216, %for.body.200.preheader
  ...
  %arrayidx201 = getelementptr inbounds float, float* %incdec.ptr, i64 %indvars.iv675
  %5 = load float, float* %arrayidx201, align 4, !tbaa !0
...
for.body.205:                                     ; preds = %for.body.205, %for.body.205.lr.ph
  %temp.0600 = phi float [ %5, %for.body.205.lr.ph ], [ %sub211, %for.body.205 ]
  %i__.4599 = phi i64 [ 1, %for.body.205.lr.ph ], [ %inc213, %for.body.205 ]
  %add207 = add nsw i64 %i__.4599, %mul206
  %arrayidx208 = getelementptr inbounds float, float* %add.ptr, i64 %add207
  %6 = load float, float* %arrayidx208, align 4, !tbaa !0
  %arrayidx209 = getelementptr inbounds float, float* %incdec.ptr, i64 %i__.4599
  %7 = load float, float* %arrayidx209, align 4, !tbaa !0
  %mul210 = fmul float %6, %7
  %sub211 = fsub float %temp.0600, %mul210
...
if.then.216.loopexit:                             ; preds = %for.body.205
  %sub211.lcssa = phi float [ %sub211, %for.body.205 ]
  br label %if.then.216

if.then.216:                                      ; preds = %if.then.216.loopexit, %for.body.200
  %temp.0.lcssa = phi float [ %5, %for.body.200 ], [ %sub211.lcssa, %if.then.216.loopexit ]
  %mul217 = mul nsw i64 %indvars.iv675, %0
  %add218 = add nsw i64 %mul217, %indvars.iv675
  %arrayidx219 = getelementptr inbounds float, float* %add.ptr, i64 %add218
  %8 = load float, float* %arrayidx219, align 4, !tbaa !0
  %div220 = fdiv float %temp.0.lcssa, %8
  store float %div220, float* %arrayidx201, align 4, !tbaa !0
