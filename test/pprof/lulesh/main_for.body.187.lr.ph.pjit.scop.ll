...
; ModuleID = 'LULESH.cc.main_for.body.187.lr.ph.pjit.scop.prototype'
...
define weak void @main_for.body.187.lr.ph.pjit.scop(i32 %conv.i, i64 %call.i, i32 %add, %struct.Mesh* nonnull %mesh)  {
newFuncRoot:
...
for.body.187.lr.ph:                               ; preds = %newFuncRoot
  ...
  %0 = getelementptr inbounds %struct.Mesh, %struct.Mesh* %mesh, i64 0, i32 13, i32 0, i32 0, i32 0
  %1 = load i32*, i32** %0
  %2 = getelementptr inbounds %struct.Mesh, %struct.Mesh* %mesh, i64 0, i32 14, i32 0, i32 0, i32 0
  %3 = load i32*, i32** %2
  %4 = getelementptr inbounds %struct.Mesh, %struct.Mesh* %mesh, i64 0, i32 15, i32 0, i32 0, i32 0
  %5 = load i32*, i32** %4
